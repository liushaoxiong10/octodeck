...
type Handlers struct {
	...
	OnWorkspaceGitStatus func(context.Context, *proto.WorkspaceGitStatusRequestFrame)
	OnWorkspaceGitCommit func(context.Context, *proto.WorkspaceGitCommitRequestFrame)
