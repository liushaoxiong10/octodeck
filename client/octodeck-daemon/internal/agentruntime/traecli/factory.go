...
// New constructs a Trae CLI agent bound to the given discovered client info
// and (optional) registry entry. The returned value satisfies the facade Agent
