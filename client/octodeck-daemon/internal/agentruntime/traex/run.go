// Package traex — run helpers.
//
// The heavy lifting (BuildRunCommand / RunPrompt / Run) lives in runtime.go.
// This file documents the supported transports for the TraeX family.
package traex

// SupportedTransports lists the transports the TraeX family understands.
