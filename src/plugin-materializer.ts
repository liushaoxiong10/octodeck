 ...
 *      marker = runtime/{userId}/snapshots/{snapshotId}/@octodeck-runtime-markers/{mp}/{plugin}.json
 ...
 */
const MARKER_DIRNAME = '@octodeck-runtime-markers';
...
/** runtime/{userId}/snapshots/{snapshotId}/@octodeck-runtime-markers/{mp}/{plugin}.json */
